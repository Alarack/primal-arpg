...
public static class AbilityEditorHelper {
    ...
    public static AbilityData DrawAbilityData(AbilityData entry) {
        ...
        entry.showProcChanceOnOtherSkills = EditorGUILayout.Toggle("Show on other Skills", entry.showProcChanceOnOtherSkills);
    ...
    public static TriggerData DrawTriggerData(TriggerData entry) {
        ...
        entry.customAnim = EditorGUILayout.TextField("Custom Anim", entry.customAnim);
    ...
    public static EffectZoneInfo DrawEffectZoneInfo(EffectZoneInfo entry) {
        ...
        entry.parentToCarrier = EditorGUILayout.Toggle("Parent to Carrier", entry.parentToCarrier);
